...
# TRAIN
model, info = trainMVShapeClassifier(train_path, cuda=True, verbose=False)
#
...
# TEST
testMVImageClassifier(test_path, model, info, pooling='mean', cuda=True, verbose=False)
testMVImageClassifier(test_path, model, info, pooling='max', cuda=True, verbose=False)